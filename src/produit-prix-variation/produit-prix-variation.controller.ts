...
*/
 ...
 async findAll() {
   ...
   // const variations =  await this.produitPrixVariationService.findAll();
...
//--------------this function  get a visit all detal il fou9 exmpale fifah tarjaa reponse
  ...
  */
  ...
  @Get(':id/details')
  async getVisitDetails(@Param('id') visitId: string): Promise<Array<Record<string, any>>> {
    try {
      const visitDetails = await this.produitPrixVariationService.getVisitDetails(visitId);
      return visitDetails;
    } catch (error) {
